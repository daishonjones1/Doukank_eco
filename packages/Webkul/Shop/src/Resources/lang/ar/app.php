...
return [
    ...
    'customer' => [
        ...
        'signup-form' => [
            ...
            'seller_message' => 'أريد أن أصبح بائعاً',
            'store_url' => 'أدخل رابط المتجر',
        ...
        'account' => [
            ...
            'store' => [
                'become-seller' => [
                    'title' => 'ابدأ البيع',
                    'page-title' => 'زبون - ابدأ البيع',
                ],
                'my-store' => [
                    'title' => 'متجري',
                    'page-title' => 'بائع - متجري'
                ],
                'index' => [
                    'title' => 'متجري',
                    'page-title' => 'متجري',
                    'edit' => 'تعديل',
                    'pending' => 'إنّ متجرك قيد المراجعة. سنقوم بإشعارك قريباً',
                    'empty' => 'متجرك الالكتروني على بعد خطوات! اشترك معنا وابدأ البيع والربح',
                    'add' => 'ابدأ البيع',
                ],
                'create' => [
                    'title' => 'فتح متجر',
                    'page-title' => 'فتح متجر',
                    'store-title' => 'اسم المتجر',
                    'url' => 'رابط المتجر',
                    'phone' => 'رقم تلفون العمل',
                    'submit' => 'حفظ المتجر',
                    'store-category' => 'نوع المتجر',
                    'select-category' => 'يرجى اختيار نوع نشاط المتجر',
                    'title-placeholder' => 'مثال: متجر خلف للأحذية'
                ]
            ]
        ]
    ],
